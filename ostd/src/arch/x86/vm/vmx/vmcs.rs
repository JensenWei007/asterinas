...
use super::msr::Msr;
use crate::{error::Error, mm::Frame, prelude::*};
...
pub(crate) fn alloc_vmcs() -> Result<Frame<()>> {
...
pub(crate) fn vmcs_revision() -> u32 {
